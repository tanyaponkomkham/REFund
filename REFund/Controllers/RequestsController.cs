...
namespace REFund.Controllers
{
    public class RequestsController : Controller
    {
        ...
        public RequestsController(CoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,EmployeeId,Detail,Amount,CreateBy,CreateAt,UpdateBy,UpdateAt,ConfirmDate")] Request request)
        {
